...
<section class="content-section">
  ...
  <p>AIRS 2026 welcomes regular research papers, short papers, work-in-progress papers, and vision papers on systems, infrastructure, algorithms, and deployment for agentic AI in real-world settings. <strong>Submissions will undergo double-anonymous peer review.</strong> We especially encourage submissions that treat agentic AI as a systems problem, connecting model inference, tools, memory, state, orchestration, scheduling, and deployment constraints.</p>
